...
export const placeholderTestimonials = [
  {
    ...
    location: "Mumbai",
    rating: 5,
    text: "Booking through StayFinder was so easy — I just messaged them on WhatsApp and had my Goa trip sorted in minutes. Highly recommend!",
  ...
  },
  {
    ...
    location: "Delhi",
    rating: 5,
    text: "The hotel exactly matched the photos and description. No surprises, no hidden charges. Will definitely book again.",
  ...
  },
  {
    ...
    location: "Bangalore",
    rating: 4,
    text: "Loved how quickly the team responded to my enquiry. Made planning our Kerala trip completely stress-free.",
