...
export const metadata = {
  ...
  description: "The terms and conditions governing your use of StayFinder.",
      ...
      <section className="py-16 bg-white">
        <div className="container-custom max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none prose-headings:font-display prose-headings:text-primary prose-a:text-secondary">
            ...
            <p>
              By accessing or using StayFinder ("the Platform"), you agree to be bound by these Terms of
              Service. If you do not agree to these terms, please do not use the Platform.
            </p>

            <h2>2. What StayFinder Is</h2>
            <p>
              StayFinder is a discovery and connection platform that helps travelers find hotels and
              restaurants, and facilitates enquiries between travelers and property owners via WhatsApp.
              StayFinder does not process payments for bookings, does not act as a booking agent, and is
            ...
            <p>
              While we make reasonable efforts to verify listing information, StayFinder does not
            ...
            <p>When using StayFinder, you agree not to:</p>
            <ul>
            ...
            <h2>5. Reviews</h2>
            <p>
              Reviews submitted on StayFinder are moderated before publication and should reflect a
            ...
            <p>
              ...
              selected at the time of purchase; StayFinder reserves the right to approve, reject, or end
              a promotion at its discretion, including in cases of policy violations.
            </p>

            <h2>7. Limitation of Liability</h2>
            <p>
              StayFinder is not liable for any disputes, losses, or damages arising from a booking,
            ...
            <p>
              All content on StayFinder, including text, graphics, logos, and design, is the property of
              StayFinder or its content partners and may not be reproduced without permission.
            </p>
