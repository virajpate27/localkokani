      ...
      <div className="bg-white rounded-2xl p-6 max-w-sm w-full animate-slide-up">
        <div className="flex items-center gap-3 mb-4">
          <div
            className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 ${
              isDangerous ? "bg-red-50 text-red-500" : "bg-primary/10 text-primary"
            }`}
          >
            <FiAlertTriangle />
          </div>
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className={`flex-1 font-medium py-2.5 rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-60 ${
              isDangerous
