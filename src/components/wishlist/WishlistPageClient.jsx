         ...
         <section className="bg-hero-gradient py-14">
           <div className="container-custom text-center">
             ...
             <p className="text-white/80 mt-3">
               Hotels you've saved for later — stored right on this device.
             </p>
           </div>
         </section>
             ...
             {!isLoaded ? (
               ...
               <div className="text-center py-10">
                 <EmptyState
                   ...
                   description="Browse hotels and tap the heart icon to save your favorites here."
                 />
                 <Link href="/hotels" className="btn-primary inline-flex items-center gap-2 mt-6">
               ...
               <>
                 <div className="flex items-center justify-between mb-6">
                   <p className="text-gray-500 text-sm">
                     ...
                     {wishlist.length === 1 ? "hotel" : "hotels"} saved
                   </p>
                   <button
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                   {wishlist.map((item) => (
                     <div key={item.id} className="card overflow-hidden group">
                       <Link href={`/hotels/${item.slug}`} className="block">
